...
document.addEventListener('DOMContentLoaded', function() {
    // Mostrar el indicador de carga al cargar la página


    // Ocultar las secciones y mostrar la sección por defecto
    desvincularDragover()
    $(".seccion").hide();
    $('#univInst').show();
    selecUniversidad();
...
function mostrarSeccion(seccion) {
    // Mostrar el indicador de carga al cambiar de sección
