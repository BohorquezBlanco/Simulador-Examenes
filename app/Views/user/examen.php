...
<body>
  ...
  <div class="mayorC">
    <div class="wrapper" id="wrapper">
      <div class="form-box login-box">
        <form action="#">
          <div class="social-box" id="listaC"></div>
          <div id="formularioMaterias"></div>
        </form>
      </div>
      <div class="overlay-box">
        <div class="overlay">
          <div class="overlay-panel" id="overlay-right">
            <h1>Hola, amigo!</h1>
            <p>Elige la carrera de la cual quieres dar el examen</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <script src="<?php echo base_url(); ?>js/crud_user/examen.js"></script>
</body>
